...
export class EquipoDirectivoComponent {
 ...
 @Input() backgroundImage: string = 'https://cdn.prod.website-files.com/636a549426aa8438b3b45fa8/6372587c9ba56f0e66ea0544_section-bg1.svg';

 teamMembers: any[] = [
  {
    name: 'Jack Freker',
    position: 'CEO',
    image: 'https://cdn.prod.website-files.com/638a2705bc615a1ffb3bf928/669ab98a302b0d881caea22e_LeanSolutionsGroup_2024_JackFrekerPhoto_FA.jpg'
  },
  {
    name: 'Robert Cadena',
