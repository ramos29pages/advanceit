  ...
  template: `
    ...
    <footer class="relative bg-purple-900 text-white">
      ...
      <!-- <div
        ...
        style="
      background: url('https://cdn.prod.website-files.com/636a549426aa8438b3b45fa8/6397864739d978c73315e760_blue-pattern-01.svg')
    ...
    "
      ...
      <div class="relative pt-10 pb-8 max-w-6xl mx-auto">
        ...
        >
          <!-- Ubicaciones -->
          <div class="flex flex-wrap items-center space-x-3 mb-4 md:mb-0">
